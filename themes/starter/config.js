...
const CONFIG = {
  ...
  STARTER_LOGO: 'https://i.postimg.cc/sggw0F2C/20241015235805.png', // 普通logo图片 示例：/images/starter/logo/logo.svg
  ...
  STARTER_HERO_BUTTON_1_URL:
    'https://www.csxf.online/about', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: '在Github上关注', // 英雄区按钮
  STARTER_HERO_BUTTON_2_URL: 'https://github.com/smallsmallq', // 英雄区按钮
 ...
 // STARTER_NAV_BUTTON_2_URL: '/sign-up',
  ...
  STARTER_FOOTER_SLOGAN: '为崇实书院的同学提供基本学习辅导资料',
  ...
  STARTER_FOOTER_LINK_GROUP: [
    {
      ...
      LINK_GROUP: [
        { TITLE: '官方主页', URL: '/#home' },
        { TITLE: '操作文档', URL: 'https://www.cxf.online/about' },
        {
          TITLE: '帮助支持',
  ...
  STARTER_CTA_TITLE: '崇实学辅',
  STARTER_CTA_TITLE_2: '',
  STARTER_CTA_DESCRIOTN:
    '西安交通大学崇实书院学业辅导与发展中心',
  STARTER_CTA_BUTTON: true, // 是否显示按钮
  STARTER_CTA_BUTTON_URL:
    'https://www.csxf.online/about',
  STARTER_CTA_BUTTON_TEXT: '开始体验',

  STARTER_POST_REDIRECT_ENABLE: true, // 默認開啟重定向
  STARTER_POST_REDIRECT_URL: 'https://www.csxf.online/about', // 重定向域名
