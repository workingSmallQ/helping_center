...
const BLOG = {
  ...
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'commerce', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 陕ICP备XXXXXXX', // 备案号 闽ICP备XXXXXXX
